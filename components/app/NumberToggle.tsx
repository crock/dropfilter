		...
		<div className="my-2 flex flex-row flex-no-wrap justify-between items-center">
			<div>
				...
				<small className="block text-gray-500 dark:text-white text-xs font-light mb-2">
					Filter domain names that contain numbers from the results.
				</small>
			</div>
			...
			<span
				...
				aria-checked={state.config.numbers}
				className={classNames(
					...
					{
						"bg-primary": state.config.numbers,
						"bg-gray-200 dark:bg-gray-400": !state.config.numbers,
					}
				)}
			>
				...
				<span
					...
					className={classNames(
						...
						{
							"translate-x-5": state.config.numbers,
							"translate-x-0": !state.config.numbers,
						}
					)}
				></span>
			</span>
